 ...
 *
 */
public abstract class AbstractDbUnitJpaTestEvaluacionAutoevaluacion {
	...
	public static void initEntityManager() throws HibernateException, DatabaseUnitException {
		...
		InputStream dataSet = Thread.currentThread().getContextClassLoader().getResourceAsStream("test-data-evaluacion-autoevaluacion.xml");
