 ...
 *
 */
public abstract class AbstractDbUnitJpaTestPreguntaAutoevaluacion {
	...
	public static void initEntityManager() throws HibernateException, DatabaseUnitException {
		...
		InputStream dataSet = Thread.currentThread().getContextClassLoader().getResourceAsStream("test-data-pregunta-autoevaluacion.xml");
