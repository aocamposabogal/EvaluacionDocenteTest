 ...
 *
 */
public class testBuscarEvaluacionAutoevaluacionFlujoBasicoBusquedaIncorrecta extends AbstractDbUnitJpaTestEvaluacionAutoevaluacion  {

	
	@Test
	public void testBuscarEvaluacionAutoevaluacionFlujoBasicoBusquedaIncorrecta_() throws Exception {
		//fail("Not yet implemented");
			...
			Assert.assertEquals(null ,evaluacionLogic.getEvaluacion(2));
		}
}
