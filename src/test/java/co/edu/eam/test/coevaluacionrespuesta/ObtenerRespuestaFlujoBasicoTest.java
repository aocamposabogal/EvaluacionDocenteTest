 ...
 */
public class ObtenerRespuestaFlujoBasicoTest extends AbstractDbUnitJpaTest{

	@Test
	public void testFlujoBasicoUnaRespuesta() {
		...
		try{	
			...
			Assert.assertEquals(1, respuestaConsultada.size());
		}
		catch (Exception e){
